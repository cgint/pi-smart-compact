...
def get_smart_prompt(serialized, previous_summary=None):
    prompt = (
        ...
        "5-10 exchanges concretely — what errors were seen, what commands were run, "
        "what the agent was investigating. This is the most important context for resumption.\n\n"
        "OUTPUT FORMAT:\n\n"
